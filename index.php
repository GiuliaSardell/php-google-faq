...
$text = [
      ...
      [
          ...
          'paragraph' => 
            ...
            'secondParagraph' => "Tieni presente che i servizi Google sono fondamentalmente gli stessi a prescindere dalla società consociata che li offre o dal paese a cui è associato il tuo account.",
          'listNum' => [ 
      ...
      [
        ...
        'subparagraph' => "Quando crei un nuovo Account Google, lo associamo a un paese in base a dove è stato creato. Per quanto riguarda gli account creati almeno un anno fa, usiamo il paese da cui accedi solitamente ai servizi Google, in genere i servizi in cui hai trascorso più tempo nell'ultimo anno. 
        <br> <br>
...
//   var_dump($singleText['title']);
//   var_dump($singleText['paragraph']);
// };
...
<div class="container">
  ...
  <?php foreach($text as $singleText){ ?>
    <div class="box">
      <h2 class="my-5"> <?php echo($singleText['title']); ?> </h2>

      <?php $paragraphArray= explode("
      ",($singleText['paragraph'])) ?>
      ...
      <div class="my-5">
        ...
        <?php $secondParagraph = $singleText['secondParagraph'] ?>
        <?php $subtitle = $singleText['subtitle'] ?>

        <?php if($listNum != '' && $listLett != ''){ ?>
        ...
        <?php } ?>
        <h5><?php echo($singleText['subtitle']); ?></h5>  
        <?php echo($singleText['subparagraph']); ?>
